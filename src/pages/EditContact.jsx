...
const EditContact = () => {
  ...
  const [editContact, { isLoading: editLoading }] =
    useEditContactMutation(token);
        ...
        <div className="  flex justify-center items-center mt-20">
          ...
          >
            ...
            <div className=" flex items-center justify-between gap-3 ">
              ...
              <button
                disabled={editLoading && true}
                className=" bg-blue-500 text-white w-1/2 py-1 rounded-sm hover:bg-blue-400"
              >
                {isLoading ? (
                  <Loader
                    color="white"
