...
const Login = () => {
  ...
  const form = useForm({
    ...
    validate: {
      ...
      password: (value) =>
        value < 5 ? "Your password must be at least 5 character" : null,
    },
  });
  ...
  return (
    <div>
      <div className={token ? "hidden" : "mt-5 ml-5 flex gap-3"}>
        <img src="/assets/contact.svg" className=" w-[30px]" alt="" />
        ...
        >
          <div className=" bg-white shadow-lg p-5 flex flex-col gap-3">
            ...
            <button
              ...
              className=" bg-blue-700 hover:bg-blue-800 h-10 text-white p-2 w-full rounded-md mt-3"
            >
              {isLoading ? (
                <Loader
                  color="white"
